...
namespace AddressBookSystem
{
    internal class AddressBookUtilityImpl : IAddressBook
    {
        ...
        internal Dictionary<string, List<Contacts>> cityData = new Dictionary<string, List<Contacts>>();

        // Dictionary To Store All Persons By State
        internal Dictionary<string, List<Contacts>> stateData = new Dictionary<string, List<Contacts>>();
        ...
        public void AddAddressBook()
        {
            try
            {
                ...
                addressBook.AddressBookName = name;

                addressData.Add(name, addressBook);
